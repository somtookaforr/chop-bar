...
<title>Chop-Bar | Products</title>
<?php include_once('db/product_db.php'); ?>
    ...
    <div class="prod_container">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="assets/img/gymrack.png" height="520rem" alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="assets/img/gymrack.png" height="520rem" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="assets/img/gymrack.png" height="520rem" alt="Third slide">
        </div>
      </div>
...
<br>
    ...
    <div class="">
        ...
        <hr>
        <?php
        $result = mysqli_query($link,"SELECT * FROM `products` WHERE `name` = 'Gym Rack'");
